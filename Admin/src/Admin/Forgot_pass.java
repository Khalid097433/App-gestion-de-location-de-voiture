...
String A = "";        
    ...
    */
    ...
    public void Modifier(String password, String mail){
        ...
        String sql = "Update Administrateur set Mot_de_passe = '"+password+"' where Email like '"+mail+"' ";
   ...
   String email_user;
    ...
    String sql = "Select Reponse from Administrateur where Question_securite like '"+Q+"' ";
...
email_user = txtemail.getText();
 ...
 String sql = "Select Question_securite from Administrateur Where EMAIL like '"+email_user+"' ";  
